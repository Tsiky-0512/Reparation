...
<%@page import="garage.razafindramasy.Facture"%>
<%@page import="garage.amby.ReparationServlet"%>
<%@page contentType="text/html" pageEncoding="UTF-8"%>

<% 
    Facture fact=new Facture();
    Reparation [] rep=(Reparation[])request.getAttribute("all_rep");
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <%if(rep[u].get_etatrep().compareTo("0")==0){%>
                        ...
                        <td><a href="modifier.jsp?idr=<%out.print(rep[u].get_idR());%>&idc=<%out.print(rep[u].makavoiture().makaclient().get_idC());%>"><span class="badge bg-success">Modifier</span></a></td>
                        ...
                        <td>Non Facturer</td>
                      <%}else{  
                            Facture fact1=fact.get_factureid(rep[u].get_idR());
                            if(fact1.get_etatfact()==null){
                      %>
                            <td>Terminer</span></a></td>
                            <td>Modifier</span></a></td>
                            <td>Supprimer</span></a></td>
                            <td><a href="facture.jsp?idr=<%out.print(rep[u].get_idR());%>&idc=<%out.print(rep[u].makavoiture().makaclient().get_idC());%>"><span class="badge bg-primary">Facturer</span></a></td>
                       <%} else{%>
                            <td>Terminer</span></a></td>
                            <td>Modifier</span></a></td>
                            <td>Supprimer</span></a></td>
                            <td>Facturer Payer </span></a></td>
                        <%}}%>
                    </tr>
                    <%}%>
                  </tbody>
